...
void OptmizeVectorDemo() {
	...
	vertices.emplace_back(1.0f, 2.0f, 3.0f);		// 1个拷贝
	vertices.emplace_back(4.0f, 5.0f, 6.0f);		// 2个拷贝，共1=2=3次拷贝
	vertices.emplace_back(7.0f, 8.0f, 9.0f);	// 3个拷贝，共1+2+3=6次拷贝
	vertices.emplace_back(17.0f, 18.0f, 19.0f); // 4个拷贝，共1+2+3+4=10个拷贝。
}